...
{
#if __PLUGIN_PRECAUTION_SCREEN_USE_LOW_POWER_ACTOR
	{&LowPowerIndicatorActorSpec, 	{64, 64, -10}, {0, 0, 0}, {1, 1, 1}, 0, NULL, NULL, NULL, false},
#endif
...
StageROMSpec PrecautionScreenStage =
{
	...
	// Actors
	{
		// UI configuration
		{
			(PositionedActor*)PrecautionScreenStageUiActors,
			__TYPE(UIContainer),
		},

		// Stage's children actors
		(PositionedActor*)PrecautionScreenStageActors,
	},
