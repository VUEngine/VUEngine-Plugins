...
#ifndef ADJUSTMENT_SCREEN_CONFIG_H_
#define ADJUSTMENT_SCREEN_CONFIG_H_
...
#ifndef __ADJUSTMENT_SCREEN_USE_LOW_POWER_ENTITY
#define __ADJUSTMENT_SCREEN_USE_LOW_POWER_ENTITY							false
#endif
...
#define __ADJUSTMENT_SCREEN_LOW_POWER_INDICATOR_Y_POSITION					1
	...
	#else
		#define __ADJUSTMENT_SCREEN_LOW_POWER_ENTITY_X_POSITION						-152
	#endif
#endif
	...
	#else
		#define __ADJUSTMENT_SCREEN_LOW_POWER_ENTITY_Y_POSITION						-100
	#endif
#endif
