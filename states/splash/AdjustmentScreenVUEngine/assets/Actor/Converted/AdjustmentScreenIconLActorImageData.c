...
const uint32 AdjustmentScreenIconLActorAdjustmentScreenIconTiles[] __attribute__((aligned(4))) =
{
	0x00000000,
...
const uint16 AdjustmentScreenIconLActorAdjustmentScreenIconMap[] __attribute__((aligned(4))) =
{
