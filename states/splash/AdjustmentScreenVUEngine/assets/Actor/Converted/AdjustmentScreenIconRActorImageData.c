...
const uint32 AdjustmentScreenIconRActorAdjustmentScreenIconTiles[] __attribute__((aligned(4))) =
{
	0x00000000,
...
const uint16 AdjustmentScreenIconRActorAdjustmentScreenIconMap[] __attribute__((aligned(4))) =
{
