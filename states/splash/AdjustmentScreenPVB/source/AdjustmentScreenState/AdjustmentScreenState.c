...
void AdjustmentScreenState::setLowPowerIndicatorPosition()
{
	...
	(
		LowPowerManager::getInstance(), __PLUGIN_ADJUSTMENT_SCREEN_PVB_LOW_POWER_INDICATOR_X_POSITION, 
		__PLUGIN_ADJUSTMENT_SCREEN_PVB_LOW_POWER_INDICATOR_Y_POSITION
	);
}
