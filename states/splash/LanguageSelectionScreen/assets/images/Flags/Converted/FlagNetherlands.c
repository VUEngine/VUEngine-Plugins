...
const uint32 FlagNetherlandsTiles[33] __attribute__((aligned(4))) =
{
    ...
    0xFFFFFFFF,0xFFF4FFF4,0xFFF4FFF4,0x55545554,0x55545554,0xFFFFFFFF,0xFFFFFFFF,0x55555555,
    0x55555555,0x55545554,0x55545554,0x00005554,0x00000000,0x55555555,0x55555555,0x00005555,
    0x00000000,
};

const uint16 FlagNetherlandsMap[20] __attribute__((aligned(4))) =
{
