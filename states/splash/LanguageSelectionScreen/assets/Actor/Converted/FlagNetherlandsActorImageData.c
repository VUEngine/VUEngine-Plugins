...
const uint32 FlagNetherlandsActorFlagNetherlandsTiles[] __attribute__((aligned(4))) =
{
	0x00000000,
...
const uint16 FlagNetherlandsActorFlagNetherlandsMap[] __attribute__((aligned(4))) =
{
