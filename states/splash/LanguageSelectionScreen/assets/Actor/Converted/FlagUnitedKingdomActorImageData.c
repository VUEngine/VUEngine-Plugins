...
const uint32 FlagUnitedKingdomActorFlagUnitedKingdomTiles[] __attribute__((aligned(4))) =
{
	0x00000000,
...
const uint16 FlagUnitedKingdomActorFlagUnitedKingdomMap[] __attribute__((aligned(4))) =
{
