...
const uint32 FlagUnitedStatesActorFlagUnitedStatesTiles[] __attribute__((aligned(4))) =
{
	0x00000000,
...
const uint16 FlagUnitedStatesActorFlagUnitedStatesMap[] __attribute__((aligned(4))) =
{
