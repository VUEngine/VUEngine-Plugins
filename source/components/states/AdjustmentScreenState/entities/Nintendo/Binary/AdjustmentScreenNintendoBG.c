...
//{{BLOCK(AdjustmentScreenNintendoBG)

//======================================================================
//
//	AdjustmentScreenNintendoBG, 96x96@2,
...
const unsigned int AdjustmentScreenNintendoBGTiles[12] __attribute__((aligned(4)))=
{
...
const unsigned short AdjustmentScreenNintendoBGMap[144] __attribute__((aligned(4)))=
{
