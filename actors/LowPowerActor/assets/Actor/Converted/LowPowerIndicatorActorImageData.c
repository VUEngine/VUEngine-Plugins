...
const uint32 LowPowerIndicatorActorLowPowerIndicatorTiles[] __attribute__((aligned(4))) =
{
	0x00000000,
...
const uint16 LowPowerIndicatorActorLowPowerIndicatorMap[] __attribute__((aligned(4))) =
{
	0x0000,0x0001,
};
